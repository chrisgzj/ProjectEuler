...
def find_smallest_odd_path(r, s, a, b, limit, counter = 1):
    ...
    global previous, prev_counter, new_counter
    if (a,b) in previous:
        prev_counter += 1
    else:
        previous.append((a,b))
...
def main():
    ...
    global previous, prev_counter, new_counter
    # Variables to explore te convenience of a dynamic programming solution.

    for limit in range(10, 100): # Greedy approach to increasing limit.
        previous = []
        prev_counter = 0
        new_counter = 0
        ...
        if counter <= limit:
            ...
            print("Not found")
        print("Prev:", prev_counter, "New:", new_counter)
        print("Prop prev", prev_counter/new_counter*100)
